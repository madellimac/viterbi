...
-- Generation Date:   Sep. 3 2012    
-- Design Name: Error_count_module_1
-- Module Name:    
-- Description: 
--
 ----------------------------------------------------------------------------------
...
entity Error_count_module_1 is
...
end Error_count_module_1;
 
architecture RTL of Error_count_module_1 is
	...
	constant bit_increment : std_logic_vector(11 downto 0) := "000000000001";
...
signal enable_dly, en_counting, falling_edge_enable, FrameErrorNb_tmp, before_xor_after : std_logic;
signal FrameErrorNb : std_logic_vector(12 downto 0);
signal BitErrorNb, accu_xor : std_logic_vector(15 downto 0);
signal overflow_val : std_logic_vector(1 downto 0);
...
accu_xor <= ("000000000000000"&before_xor_after) ;
...
FrameErrorNb_tmp <= FrameErrorNb_tmp or before_xor_after ;
